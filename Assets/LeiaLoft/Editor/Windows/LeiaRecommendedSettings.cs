...
namespace LeiaLoft
{
    ...
    public class LeiaRecommendedSettings : EditorWindow
    {
        ...
        public static void Init()
        {
            ...
            window = GetWindow<LeiaRecommendedSettings>("LeiaLoft SDK Recommended Settings", true);
        ...
        static void InitRecommendations()
        {
            ...
            recommendations.Add(new Recommendation(
                "Anti-Aliasing",
                 ...
                 "Anti Aliasing can be set within LeiaDisplay",
                 "LeiaLoft.Ignore.AntiAliasing"));
