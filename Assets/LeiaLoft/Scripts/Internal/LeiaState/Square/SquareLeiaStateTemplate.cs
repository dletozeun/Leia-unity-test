...
namespace LeiaLoft
{
    ...
    {
		public static string OpaqueShaderName { get { return "LeiaLoft/LeiaLoft_Square"; } }
		public static string OpaqueShaderNameLimitedViews { get { return "LeiaLoft/LeiaLoft_Square_Limited"; } }

        public static string TransparentShaderName { get { return "LeiaLoft/LeiaLoft_Square_Limited"; } }
        public static string TransparentShaderNameLimitedViews { get { return "LeiaLoft/LeiaLoft_Square_Limited_Blending"; } }

        //Sharpening
        public static string SharpeningShaderName { get { return "LeiaLoft/ViewSharpening"; } }
        ...
        public void UpdateSharpeningParameters()
        {
            if (_sharpening == null)
            {
                _sharpening = new Material(Shader.Find(SharpeningShaderName));
            }
