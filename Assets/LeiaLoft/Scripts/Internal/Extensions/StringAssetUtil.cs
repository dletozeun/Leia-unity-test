...
namespace LeiaLoft
{
    ...
    public static class StringAssetUtil
    {
        ...
        [Obsolete("Devs should now provide another bool param to signal whether, when in editor, they wish the Resource to be reloaded.")]
        public static bool WriteJsonObjectToDeviceAwareFilename(string filename, object jsonObj)
        {
            return WriteJsonObjectToDeviceAwareFilename(filename, jsonObj, false);
