...
{
    /// <summary>
    /// This class demonstrates uses of LeiaQuadVideoPlayer, seperates UI from implemetation for modularity. We encourage developers use this sample as a starting point.
    /// </summary>
...
#pragma warning restore 0649
        ...
        void Start()
        {
            ...
            {
                LogUtil.Log(LogLevel.Warning, "Ensure LeiaQuadVideoPlayer is assigned in the Editor");
            }
        ...
        {
            _videoProgressSlider.value = _leiaMediaVideo.GetVideoProgress();
            ...
            if (durationSeconds > 0.0f)
            {
                ...
                _currentTimeText.text = string.Format("{0}:{1:D2}", durationTimespan.Minutes, durationTimespan.Seconds);
            }
            else
            {
